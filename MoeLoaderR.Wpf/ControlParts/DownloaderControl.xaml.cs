...
public partial class DownloaderControl
{
    ...
    public void Init(Settings settings)
    {
        ...
        StopSelectedButton.Click += StopButtonOnClick;
        RetrySelectedButton.Click += RetryButtonOnClick;
        ClearCompletedButton.Click += DeleteAllButtonOnClick;
        ClosePanelButton.Click += delegate
        {
            if (Application.Current.MainWindow is MainWindow window)
                window.DownloaderMenuCheckBox.IsChecked = false;
        };
        KeyDown += OnKeyDown;
